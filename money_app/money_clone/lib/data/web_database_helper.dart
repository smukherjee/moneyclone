...
class WebDatabaseHelper {
  ...
  static Future<void> initialize() async {
    ...
    if (!_initialized) {
      try {
        ...
        _initialized = true;
        _logger.info('Web database factory initialized successfully');
      } catch (e) {
  ...
  static Future<Database> openWebDatabase(
    String name, {
    ...
    if (!kIsWeb) {
      throw UnsupportedError(
        'WebDatabaseHelper should only be used on web platform',
      );
    }
    ...
    try {
      ...
      _logger.error('Error opening web database', e);
      rethrow;
    }
  }
}
